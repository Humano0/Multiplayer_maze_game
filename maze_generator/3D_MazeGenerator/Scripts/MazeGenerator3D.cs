...
{
    //Both mazeRows and mazeColumns must be even numbers. Otherwise, it will be reduced by 1.
    public int mazeRows;
    ...
    // Size of the cells, used to determine how far will new cells will be placed during generation.
    private float cellSize;

    private GameObject mazeParent;

    //Delete what's inside Start() later. 
    //This is only for quick presentation.
    private void Start()
    {
    ...
    public void CreateLayout()
    {
        ...
        // #TODO Change the starting and spawn position to vector3 and relocate respectively 
        Vector2 startPos = new Vector2(-(cellSize * (mazeColumns / 2)) + (cellSize / 2), -(cellSize * (mazeRows / 2)) + (cellSize / 2));
        Vector2 spawnPos = startPos;

        // #TODO Change y to z && vector3
    ...
    // #TODO Some changes required (eg. change y t)
    ...
    // #TODO Again lookup gridpos for 3d.
    ...
    // #TODO check if vector3 is needed
